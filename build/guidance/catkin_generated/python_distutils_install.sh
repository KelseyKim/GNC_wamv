...
echo_and_run cd "/home/ktkim/Workspaces/GNC_wamv/src/guidance"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ktkim/Workspaces/GNC_wamv/src/guidance/setup.py" \
     \
    build --build-base "/home/ktkim/Workspaces/GNC_wamv/build/guidance" \
    install \
    --root="${DESTDIR-/}" \
